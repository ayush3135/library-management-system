 import java.awt.*;
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("main/java/library/management/system/icons/second.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("main/java/library/management/system/icons/third.png"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("main/java/library/management/system/icons/fourth.png"));
        ...
        contentpane.add(l4);
           ...
           panel.setBorder(new TitledBorder(new LineBorder(new Color(250,128,114),2),"Operation",
           ...
           ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("main/java/library/management/system/icons/fifth.png"));
           ...
           ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("main/java/library/management/system/icons/sixth.png"));
           ...
           ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("main/java/library/management/system/icons/seventh.png"));
           ...
           panel2.setBorder(new TitledBorder(new LineBorder(new Color(205,133,63),2),"Action",
